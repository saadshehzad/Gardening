...
class Plant(models.Model):
    ...
    growth_stage = models.CharField(max_length=500, default="Seed")  
    ...
    soil_ph = models.CharField(max_length=200, blank=True, null=True)
    hardiness = models.CharField(max_length=200)  
    temperature_min = models.CharField(max_length=200, blank=True, null=True)
    temperature_max = models.CharField(max_length=200, blank=True, null=True)
    humidity_preference = models.CharField(max_length=500, blank=True, null=True)
    ...
    health_status = models.CharField(max_length=500, default="Healthy")
